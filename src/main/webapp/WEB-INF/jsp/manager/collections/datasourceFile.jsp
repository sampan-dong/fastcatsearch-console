									...
									<div class="row">
										<div class="col-md-12 form-horizontal">
											<div class="form-group">
												...
												<div class="col-md-10"><input type="text" name="regular" class="form-control" value="org.fastcatsearch.datasource.reader.FileReader"></div>
											</div>
													...
													<div class="tab-content">
														<div class="tab-pane active" id="tab_3_1">
															<form class="form-horizontal" action="#">
																<div class="col-md-12">
																	<div class="form-group">
																		<label class="col-md-2 control-label">Data Path :</label>
																		<div class="col-md-10"><textarea name="regular" class="form-control"></textarea></div>
																	</div>
				
																	<div class="form-group">
																		<label class="col-md-2 control-label">Delete-ID Path :</label>
																		<div class="col-md-10"><textarea name="regular" class="form-control"></textarea></div>
																	</div>
																</div>
															</form>
